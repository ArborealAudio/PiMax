...
DefaultDirName={autocf32}
DefaultGroupName={#name}
DisableProgramGroupPage=yes
DisableWelcomePage=no
OutputBaseFilename={#name}-win32
...
begin
  ...
  DirPage.Values[0] := GetPreviousData('Directory1', 'C:\Program Files (x86)\Steinberg\VSTPlugins');
  DirPage.Values[1] := GetPreviousData('Directory2', 'C:\Program Files (x86)\Common Files\VST3');
  DirPage.Values[2] := GetPreviousData('Directory3', 'C:\Program Files (x86)\Common Files\CLAP');
end;
